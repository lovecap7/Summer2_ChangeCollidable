...
SmallDragonStateSearch::~SmallDragonStateSearch()
{
}

void SmallDragonStateSearch::Init()
{
	//次の状態を今の状態に更新
	ChangeState(shared_from_this());
}

void SmallDragonStateSearch::Update(const std::weak_ptr<GameCamera> camera, const std::weak_ptr<ActorManager> actorManager)
{
	//コライダブル
	auto coll = std::dynamic_pointer_cast<SmallDragon>(m_owner.lock());
	//死亡
